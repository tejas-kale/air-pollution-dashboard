...
def load_environment():
    ...
    if not env_path.exists():
        warnings.warn(
            ".env file not found. Assuming required environment variables are "
            "already set.\n"
            "If environment variables are not set, please create a .env file "
            "from .env.example and re-run the application."
        )
        return
